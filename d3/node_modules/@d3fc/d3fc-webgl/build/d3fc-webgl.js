(function (global, factory) {
    ...
    var programBuilder = (function () {
      ...
      var build = function build(count) {
        ...
        switch (mode) {
          ...
          default:
            {
              throw new Error("Unsupported drawing mode ".concat(mode, "."));
            }
        }
      };
    ...
    var baseAttributeBuilder = (function () {
      ...
      var baseAttribute = function baseAttribute(programBuilder) {
        ...
        extInstancedArrays.vertexAttribDivisorANGLE(location, programBuilder.instanced() ? divisor : 0);
      };
    ...
    var vertexAttribute = (function () {
      ...
      vertexAttribute.clear = function () {
        base.buffer(null);
        projector.clear();
      };

      d3fcRebind.rebind(vertexAttribute, base, 'normalized', 'location');
      d3fcRebind.rebind(vertexAttribute, projector, 'data', 'value', 'size', 'type');
    ...
    var adjacentElementAttribute = (function () {
      ...
      adjacentAttribute.offset = function (offset) {
        ...
        d3fcRebind.rebind(offsetAttribute, base, 'location');
        d3fcRebind.rebind(offsetAttribute, adjacentAttribute, 'clear');
      ...
      d3fcRebind.rebind(adjacentAttribute, base, 'normalized', 'location');
    ...
    var elementAttribute = (function () {
      ...
      elementAttribute.clear = function () {
        base.buffer(null);
        projector.clear();
      };

      d3fcRebind.rebind(elementAttribute, base, 'normalized', 'location');
      d3fcRebind.rebind(elementAttribute, projector, 'data', 'value', 'size', 'type');
    ...
    var fillColor$2 = (function () {
      ...
      d3fcRebind.rebind(fillColor$2, attribute, 'data');
      return fillColor$2;
    });
    ...
    var strokeColor$2 = (function () {
      ...
      d3fcRebind.rebind(strokeColor$2, attribute, 'data');
      return strokeColor$2;
    });
